...
public class MWOverlay extends View {
  ...
  private static TextView viewFinderView;
    ...
    if (typeface != null) {
      ...
      paint.setTypeface(viewFinderView.getTypeface());
      paint.setTextSize(viewFinderView.getTextSize());
      Rect bounds = new Rect();
      paint.getTextBounds(viewFinderLabel, 0, 1, bounds);
      textView.setTranslationY((float) height / 2.f + (float) bounds.height() / 1.8f);
    }
